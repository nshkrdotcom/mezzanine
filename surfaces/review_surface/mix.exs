defmodule MezzanineReviewSurface.MixProject do
  use Mix.Project

  def project do
    [
      app: :mezzanine_review_surface,
      version: "0.1.0",
      elixir: "~> 1.19",
      start_permanent: Mix.env() == :prod,
      deps: deps(),
      aliases: aliases(),
      description: "Review decisions and release surface for Mezzanine",
      docs: [main: "readme", extras: ["README.md"]],
      name: "Mezzanine Review Surface",
