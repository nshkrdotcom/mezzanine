defmodule MezzanineProgramSurface.MixProject do
  use Mix.Project

  def project do
    [
      app: :mezzanine_program_surface,
      version: "0.1.0",
      elixir: "~> 1.19",
      start_permanent: Mix.env() == :prod,
      deps: deps(),
      aliases: aliases(),
      description: "Northbound program and policy administration for Mezzanine",
      docs: [main: "readme", extras: ["README.md"]],
      name: "Mezzanine Program Surface",
