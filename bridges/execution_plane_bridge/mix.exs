defmodule MezzanineExecutionPlaneBridge.MixProject do
  use Mix.Project

  def project do
    [
      app: :mezzanine_execution_plane_bridge,
      version: "0.1.0",
      elixir: "~> 1.19",
      start_permanent: Mix.env() == :prod,
      deps: deps(),
      aliases: aliases(),
      description: "Future execution-plane boundary for Mezzanine",
      docs: [main: "readme", extras: ["README.md"]],
      name: "Mezzanine Execution Plane Bridge",
