defmodule MezzanineDecisionEngine.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      description: "Durable decision and review ledger for Mezzanine",
      docs: [main: "readme", extras: ["README.md"]],
      name: "Mezzanine Decision Engine",
  ...
  def application do
    [
      mod: {Mezzanine.Decisions.Application, []},
