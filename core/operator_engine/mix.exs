defmodule MezzanineOperatorEngine.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      description: "Operator pause, resume, and cancel substrate for Mezzanine",
      docs: [main: "readme", extras: ["README.md"]],
      name: "Mezzanine Operator Engine",
