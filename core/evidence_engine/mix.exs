defmodule MezzanineEvidenceEngine.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      description: "Durable evidence ledger and completeness helpers for Mezzanine",
      docs: [main: "readme", extras: ["README.md"]],
      name: "Mezzanine Evidence Engine",
  ...
  def application do
    [
      mod: {Mezzanine.EvidenceLedger.Application, []},
