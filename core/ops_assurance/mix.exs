defmodule MezzanineOpsAssurance.MixProject do
  use Mix.Project

  def project do
    [
      app: :mezzanine_ops_assurance,
      version: "0.1.0",
      elixir: "~> 1.19",
      start_permanent: Mix.env() == :prod,
      deps: deps(),
      aliases: aliases(),
      description: "Review, waiver, escalation, and release-readiness services for Mezzanine",
