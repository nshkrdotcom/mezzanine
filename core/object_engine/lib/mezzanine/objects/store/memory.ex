defmodule Mezzanine.Objects.Store.Memory do
  @moduledoc "Memory-only object store adapter."
  @behaviour Mezzanine.Objects.Store

  alias Mezzanine.Persistence.MemoryStore

  @namespace :mezzanine_objects_store

  def capabilities, do: Mezzanine.Persistence.memory_capability(:objects, [:objects])
