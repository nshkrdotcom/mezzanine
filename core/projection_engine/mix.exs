defmodule MezzanineProjectionEngine.MixProject do
  use Mix.Project
  ...
  def project do
    [
      app: :mezzanine_projection_engine,
      version: "0.1.0",
      elixir: "~> 1.19",
      ...
      deps: deps(),
      aliases: aliases(),
      dialyzer: [plt_add_deps: :apps_tree, plt_add_apps: [:ex_unit]],
      description: "Durable projection rows and materialized views for Mezzanine",
      docs: [main: "readme", extras: ["README.md"]],
      name: "Mezzanine Projection Engine",
  ...
  def application do
    [
      mod: {Mezzanine.Projections.Application, []},
  ...
  defp deps do
    [
      ...
      {:mezzanine_substrate_model, path: "../substrate_model"},
      {:ash, "~> 3.24"},
      {:ash_postgres, "~> 2.6"},
      {:ecto_sql, "~> 3.13"},
      {:postgrex, ">= 0.0.0"},
