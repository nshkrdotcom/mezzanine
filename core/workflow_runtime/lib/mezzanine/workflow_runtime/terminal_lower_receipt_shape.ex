defmodule Mezzanine.WorkflowRuntime.TerminalLowerReceiptShape do
  ...
  def from_workflow_signal(attrs) when is_map(attrs) do
    ...
    %{
      ...
      ambiguity_state: payload_value(attrs, routing, :ambiguity_state),
      continuation_ref: payload_value(attrs, routing, :continuation_ref),
      retry_posture: payload_value(attrs, routing, :retry_posture),
  ...
  def from_deterministic_completion(execution, accepted, facts, attrs)
    ...
    %{
      ...
      "ambiguity_state" => map_value(facts, :ambiguity_state),
      "continuation_ref" => map_value(facts, :continuation_ref),
      "retry_posture" => map_value(facts, :retry_posture),
