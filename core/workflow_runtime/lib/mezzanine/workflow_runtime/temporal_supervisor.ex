defmodule Mezzanine.WorkflowRuntime.TemporalSupervisor do
  ...
  @task_queue_instance_modules [
    ...
    {Mezzanine.WorkflowRuntime.PrelimTemporal, "mezzanine.agentic",
     Mezzanine.WorkflowRuntime.PrelimTemporal.MezzanineAgentic},
    {Mezzanine.WorkflowRuntime.PrelimTemporal, "mezzanine.hazmat",
     Mezzanine.WorkflowRuntime.PrelimTemporal.MezzanineHazmat},
    {Mezzanine.WorkflowRuntime.PrelimTemporal, "mezzanine.review",
     Mezzanine.WorkflowRuntime.PrelimTemporal.MezzanineReview},
    {Mezzanine.WorkflowRuntime.PrelimTemporal, "mezzanine.semantic",
     Mezzanine.WorkflowRuntime.PrelimTemporal.MezzanineSemantic},
    {Mezzanine.WorkflowRuntime.StackLabPhase6Temporal, "mezzanine.agentic",
     Mezzanine.WorkflowRuntime.StackLabPhase6Temporal.MezzanineAgentic},
    {Mezzanine.WorkflowRuntime.StackLabPhase6Temporal, "mezzanine.hazmat",
     Mezzanine.WorkflowRuntime.StackLabPhase6Temporal.MezzanineHazmat},
    {Mezzanine.WorkflowRuntime.StackLabPhase6Temporal, "mezzanine.review",
     Mezzanine.WorkflowRuntime.StackLabPhase6Temporal.MezzanineReview},
    {Mezzanine.WorkflowRuntime.StackLabPhase6Temporal, "mezzanine.semantic",
     Mezzanine.WorkflowRuntime.StackLabPhase6Temporal.MezzanineSemantic}
  ]
