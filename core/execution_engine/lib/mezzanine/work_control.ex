defmodule Mezzanine.WorkControl do
  ...
  defp phase2_runtime_metadata(attrs) do
    ...
    |> maybe_put("memory_profile_ref", map_value(attrs, :memory_profile_ref))
    |> maybe_put("context_profile_ref", map_value(attrs, :context_profile_ref))
    |> maybe_put("memory_context_required", map_value(attrs, :memory_context_required))
    |> maybe_put("memory_context_source_refs", list_value(attrs, :memory_context_source_refs))
    |> maybe_put("memory_context_binding_keys", list_value(attrs, :memory_context_binding_keys))
